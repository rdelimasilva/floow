...
/**
 * Casos do par de transferência (spec de 24/09), separados de
 * `counterparty-actions.test.ts` pelo limite de tamanho: mesmo mock de fila,
 * mais a condição de `where` renderizada, porque filtro de lote só se prova
 * olhando o SQL.
 */
describe('confirmCounterparty — par de transferência', () => {
